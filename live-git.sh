...
LIVEDEVELOP="/mnt/sda7/livedevelop/wheezy/i386_iso-hybrid"
LIVEDEVELOP_GIT="/mnt/sda7/livedevelop-git"
...
#rm -f ${LIVEDEVELOP_GIT}/config/packages.chroot/live-build_*.deb
rm -f ${LIVEDEVELOP_GIT}/config/packages.chroot/live-{boot,config,tools}*.deb
...
#cp live-build_*.deb ${LIVEDEVELOP_GIT}/i386_iso-hybrid-backports/config/packages.chroot/
cp live-tools_*.deb ${LIVEDEVELOP_GIT}/i386_iso-hybrid-backports/config/packages.chroot/
cp live-boot{_,-initramfs-tools,-doc}*.deb  ${LIVEDEVELOP_GIT}/i386_iso-hybrid-backports/config/packages.chroot/
cp live-config{_,-sysvinit,-doc}*.deb  ${LIVEDEVELOP_GIT}/i386_iso-hybrid-backports/config/packages.chroot/

#cp live-build_*.deb ${LIVEDEVELOP_GIT}/amd64_iso-hybrid/config/packages.chroot/
cp live-tools_*.deb ${LIVEDEVELOP_GIT}/amd64_iso-hybrid/config/packages.chroot/
cp live-boot{_,-initramfs-tools,-doc}*.deb  ${LIVEDEVELOP_GIT}/amd64_iso-hybrid/config/packages.chroot/
cp live-config{_,-sysvinit,-doc}*.deb  ${LIVEDEVELOP_GIT}/amd64_iso-hybrid/config/packages.chroot/
rm -R -f -v /tmp/live
